    ...
    <div class=" container-fluid my-auto"> <br>
      ...
      <div class="row">
        <div class=" col-lg-6 my-auto">
          ...
          <a href="" class = " btn btn-lg btn-primary">Call For Action</a> </div>
        <div class="col-lg-6">
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 py-5">
        ...
        <a href="about-us.php" class="btn btn-primary">Know More</a> </div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text"> <b> Courses:</b> 5<br>
              <b>Rating:</b> <i class="fa fa-star text-warning"></i> <i class="fa fa-star text-warning"></i> <i class="fa fa-star text-warning"></i> <i class="fa fa-star text-warning"></i> <i class="fa fa-star text-warning"></i> </p>
          </div>
        </div>
      </div>
      <?php
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          ...
          <img src="assets/images/p2.jpg" alt="" class="img-fluid rounded" > </div>
        <div class="col-lg-6 my-auto" >
          <div class="row ">
    ...
    <div class="row">
      <div class="col-6">
        <div class="border rounded position-relative">
          ...
          <i class="fa fa-quote-left fa-3x position-absolute" style="top:.5rem;left:.5rem; opacity: .2"></i> </div>
